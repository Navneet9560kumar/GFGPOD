...
public class CounttheCoprime {
    ...
    public static void main(String[] args) {
        CounttheCoprime cp = new CounttheCoprime();

        // Example input
        int[] arr = {1, 2, 3, 4, 5};

        // Output the number of co-prime pairs
        int result = cp.cntCoprime(arr);
        System.out.println("Number of co-prime pairs: " + result);
    }
}
